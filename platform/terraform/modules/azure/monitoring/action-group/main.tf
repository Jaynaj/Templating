resource "azurerm_monitor_action_group" "this" {
  ...
  dynamic "webhook_receiver" {
    ...
    content {
      ...
      use_common_alert_schema = lookup(webhook_receiver.value, "use_common_alert_schema", false)
    }
  }
  ...
  dynamic "azure_function_receiver" {
    ...
    content {
      ...
      use_common_alert_schema  = lookup(azure_function_receiver.value, "use_common_alert_schema", false)
    }
  }
  ...
  dynamic "logic_app_receiver" {
    ...
    content {
      ...
      use_common_alert_schema = lookup(logic_app_receiver.value, "use_common_alert_schema", false)
    }
  }
